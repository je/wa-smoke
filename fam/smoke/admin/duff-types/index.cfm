...
<cfquery name="duff_types_get" datasource="Washington_Smoke_Production">
SELECT *
FROM LU_Duff_Type
</cfquery>

<cfquery name="drop_duff_types" datasource="FAMDB">
if exists (select * from information_schema.tables where table_name = 'smoke_duff_types')
    drop table smoke_duff_types;
</cfquery>

<cfquery name="make_duff_types" datasource="FAMDB">        
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE smoke_duff_types(
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[Descr] [nvarchar](25) NOT NULL
) ON [PRIMARY]
</cfquery>

<cfoutput query="duff_types_get">
<cfquery name="duff_types_load" datasource="FAMDB">
set identity_insert smoke_duff_types on
insert into smoke_duff_types (
id,
descr
)
VALUES
...
set identity_insert smoke_duff_types off
</cfquery>
</cfoutput>
...
<cfoutput>#tada.recordcount#</cfoutput> <strong>Duff Types</strong>
<small></small>
