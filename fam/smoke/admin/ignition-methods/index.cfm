...
<cfquery name="ignition_methods_get" datasource="Washington_Smoke_Production">
SELECT *
FROM LU_Ignition_Methods
</cfquery>

<cfquery name="drop_ignition_methods" datasource="FAMDB">
if exists (select * from information_schema.tables where table_name = 'smoke_ignition_methods')
    drop table smoke_ignition_methods;
</cfquery>

<cfquery name="make_ignition_methods" datasource="FAMDB">        
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE smoke_ignition_methods(
...
<cfoutput query="ignition_methods_get">
<cfquery name="ignition_methods_load" datasource="FAMDB">
set identity_insert smoke_ignition_methods on
insert into smoke_ignition_methods (
id,
code,
descr
)
...
set identity_insert smoke_ignition_methods off
</cfquery>
</cfoutput>
...
<cfoutput>#tada.recordcount#</cfoutput> <strong>Ignition Methods</strong>
<small></small>
