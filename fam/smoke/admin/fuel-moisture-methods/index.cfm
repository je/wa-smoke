...
<cfquery name="fuel_moisture_methods_get" datasource="Washington_Smoke_Production">
SELECT *
FROM LU_Fuel_Moisture_Method
</cfquery>

<cfquery name="drop_fuel_moisture_methods" datasource="FAMDB">
if exists (select * from information_schema.tables where table_name = 'smoke_fuel_moisture_methods')
    drop table smoke_fuel_moisture_methods;
</cfquery>

<cfquery name="make_fuel_moisture_methods" datasource="FAMDB">        
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
CREATE TABLE smoke_fuel_moisture_methods(
	[FMM_Key] [int] IDENTITY(1,1) NOT NULL,
	[Code] [int] NULL,
	[Descr] [varchar](30) NULL
) ON [PRIMARY]
</cfquery>

<cfoutput query="fuel_moisture_methods_get">
<cfquery name="fuel_moisture_methods_load" datasource="FAMDB">
set identity_insert smoke_fuel_moisture_methods on
insert into smoke_fuel_moisture_methods (
FMM_Key,
code,
descr
)
...
set identity_insert smoke_fuel_moisture_methods off
</cfquery>
</cfoutput>
...
SELECT *
FROM smoke_fuel_moisture_methods
</cfquery>
...
<cfoutput>#tada.recordcount#</cfoutput> <strong>Fuel Moisture Methods</strong>
<small></small>
