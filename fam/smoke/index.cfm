...
<div style="padding-right:20px;">
    ...
    <div class="panel panel-default" style="max-width:none;">
        <div class="panel-heading">
            ...
            <a href="/fam/smoke/"><strong>Washington State Smoke Reporting</strong></a>
            </h3>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
				<br>
				<a href='/fam/smoke/district/'>/district/</a> - districts<br>
				<br>
				<a href='/fam/smoke/date/?2016-09-14'>/date/?2016-09-14</a> - example date page<br>
				<a href='/fam/smoke/date/?2016-09-xx'>/date/?2016-09-xx</a> - example month page<br>
				<a href='/fam/smoke/date/?2016-xx-xx'>/date/?2016-xx-xx</a> - example year page<br>
				<br>
...
<script src="/fam/smoke/google.js"></script>
            ...
            <script type="text/javascript">
              ...
              mp.addTo(map);
                ...
                op#Burn_Unit_ID_No#.bindPopup('<a href="/fam/smoke/data/?#Burn_Unit_ID_No#">#Burn_Project_Name#</a>');
                </cfoutput>
                </cfloop>
